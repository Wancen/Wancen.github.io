---
title: "nullranges"
excerpt: "A hierarchical Bayesian modeling to estimate cell type specific allelic imbalance per gene in single-cell RNA-seq or dynamic allelic imbalance per gene in bulk RNA-seq.<br/><img src='/images/nullranges.png' width='200'>"
collection: research
order: 2
---
...
<div style="text-align: center;">
  <img src="/images/bookranges.jpeg" alt="drawing" width="500"/>
</div>
...
# Selected important results by bootRanges
------
<p style="text-align: justify">
...
# Tutorial of nullranges
------
We provided a tutorial for running airpart in details, with all kinds of visualization plots provided. 
Package Website: [nullranges Tutorial](https://www.bioconductor.org/packages/release/bioc/vignettes/airpart/inst/doc/airpart.html)